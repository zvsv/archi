    ...
    protected void createControls(Composite parent) {
        ...
        ((Text)fTextName.getTextControl()).addFocusListener(new FocusListener() {
            ...
            public void focusGained(FocusEvent e) {
                ...
                if(isAlive(getFirstSelectedObject()) && getFirstSelectedObject() instanceof IArchimateConcept) {
                    duplicateNameHandler = new DuplicateNameHandler((Text)fTextName.getTextControl(), (IArchimateConcept)getFirstSelectedObject());
                }
            }
